...
insert into item (name,price,category_id) values('Body Wash Soap',2205,null);

insert into customer(name) values ('Andrew');
insert into customer(name) values ('Sophia');
insert into customer(name) values ('William');
insert into customer(name) values ('Jhon');
insert into cus_item values () values (1,1);
insert into cus_item values () values (5,1);
insert into cus_item values () values (10,1);
insert into cus_item values () values (20,1);

insert into cus_item values () values (11,2);
insert into cus_item values () values (13,2);
insert into cus_item values () values (25,2);
